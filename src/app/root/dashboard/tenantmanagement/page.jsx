  ...
  return (
    <div className='w-full bg-gray-100 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex justify-center min-h-screen p-4 md:p-6'>
        <div className="w-full">
                ...
                <Breadcrumb className="mb-4">
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            ...
                            <BreadcrumbLink href="/" className="ml-2 font-semibold text-slate-800 dark:text-slate-200">Home</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator>
                            <FiChevronRight className="h-4 w-4 text-slate-500 dark:text-slate-500" />
                        </BreadcrumbSeparator>
                        <BreadcrumbItem>
                            <BreadcrumbLink className="font-semibold text-slate-800 dark:text-slate-200">Root</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator>
                            <FiChevronRight className="h-4 w-4 text-slate-500 dark:text-slate-500" />
                        </BreadcrumbSeparator>
                        <BreadcrumbItem>
                            <BreadcrumbLink className="font-semibold text-slate-800 dark:text-slate-200">Dashboard</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator>
                            <FiChevronRight className="h-4 w-4 text-slate-500 dark:text-slate-500" />
                        </BreadcrumbSeparator>
                        <BreadcrumbItem>
                            <BreadcrumbLink className="font-semibold text-slate-800 dark:text-slate-200">Tenant Management</BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
                        ...
                        <div className="w-full md:w-48">
                            <Select value={statusFilter} onValueChange={setStatusFilter}>
                                ...
                                <SelectContent className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700">
                                    <SelectItem value="all" className="focus:bg-slate-50 dark:focus:bg-slate-700">All Status</SelectItem>
                                    <SelectItem value="active" className="focus:bg-slate-50 dark:focus:bg-slate-700">Active</SelectItem>
                                    <SelectItem value="pending" className="focus:bg-slate-50 dark:focus:bg-slate-700">Pending</SelectItem>
                                    <SelectItem value="suspended" className="focus:bg-slate-50 dark:focus:bg-slate-700">Suspended</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">{tenants?.length || 0}</p>
                            </div>
                ...
                <Card className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-slate-200/50 dark:border-slate-800/50">
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm font-medium text-slate-600 dark:text-slate-400">On Free Trial</p>
            ...
            <Card className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-slate-200/50 dark:border-slate-800/50">
                <CardHeader>
                    <CardTitle className="text-slate-900 dark:text-slate-100">Tenant List</CardTitle>
                ...
                <CardContent>
                        ...
                        <Table>
                            <TableHeader>
                                <TableRow className="border-slate-200 dark:border-slate-800">
                                    <TableHead className="text-slate-700 dark:text-slate-300">Organization</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300">Owner</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300">Contact</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300">Status</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300">Trial</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300 text-center">Created</TableHead>
                                    <TableHead className="text-slate-700 dark:text-slate-300 text-right">Actions</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {filteredTenants.map((tenant) => (
                                    <TableRow key={tenant._id} className="border-slate-200 dark:border-slate-800">
                                        <TableCell>
                                            <div>
                                                <p className="font-medium text-slate-900 dark:text-slate-100">{tenant.organizationName}</p>
                                        ...
                                        <TableCell>
                                            <p className="font-medium text-slate-900 dark:text-slate-100">{tenant.ownerName}</p>
                                        </TableCell>
                                        <TableCell>
                                            ...
                                            <div className="flex justify-end space-x-2">
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                                                        <AlertDialogHeader>
                                                            <AlertDialogTitle className="text-slate-900 dark:text-slate-100">Delete Tenant</AlertDialogTitle>
                    ...
                    {filteredTenants.length === 0 && (
                        <div className="text-center py-8">
                            <p className="text-slate-500 dark:text-slate-400">No tenants found matching your criteria.</p>
                        </div>
                    )}
                </CardContent>
            </Card>
            ...
            <Dialog open={isViewDialogOpen} onOpenChange={setIsViewDialogOpen}>
                <DialogContent className="max-w-2xl bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
                    <DialogHeader>
                        <DialogTitle className="text-slate-900 dark:text-slate-100">Tenant Details</DialogTitle>
                    ...
                    {selectedTenant && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <h3 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Organization Information</h3>
                                <div className="space-y-2">
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Organization Name</Label>
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.organizationName}</p>
                                    </div>
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Owner Name</Label>
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.ownerName}</p>
                                    </div>
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Email</Label>
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.email}</p>
                                    </div>
                                    <div>
                            ...
                            <div>
                                <h3 className="font-semibold mb-3 text-slate-900 dark:text-slate-100">Subscription Details</h3>
                                <div className="space-y-2">
                                    <div>
                                    ...
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Free Trial</Label>
                                        <div className="mt-1">
                                            {selectedTenant.tenantOnFreeTrial ? (
                                                ...
                                                <Badge variant="outline" className="bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-300">
                                                    Not Active
                                                </Badge>
                                            )}
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.tenantCurrency}</p>
                                    </div>
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Language</Label>
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.tenantLanguage}</p>
                                    </div>
                                    <div>
                                        <Label className="text-sm font-medium text-slate-600 dark:text-slate-400">Timezone</Label>
                                        <p className="text-sm text-slate-900 dark:text-slate-100">{selectedTenant.tenantTimezone}</p>
                                    </div>
                                    <div>
