...
const StaffManagement = () => {
  ...
  const fetchAllStaffs = async ({ queryKey }) => {
    ...
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/staffsmanagement?page=${page}&limit=${limit}&staffSearchQuery=${searchQuery}`
      );
  ...
  const handleSubmitStaff = async (data) => {
    ...
    try {
      const url = currentStaffId
        ? `http://88.198.112.156:8000/api/staffsmanagement/changedetails/${currentStaffId}`
        : "http://88.198.112.156:8000/api/staffsmanagement/create";
  ...
  const deleteStaff = async (id) => {
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/staffsmanagement/remove/${id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const editStaffDetails = async (id) => {
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/staffsmanagement/${id}`
      );
      const responseBody = await response.json();
      if (response.ok) {
        setEditStaff(true);
