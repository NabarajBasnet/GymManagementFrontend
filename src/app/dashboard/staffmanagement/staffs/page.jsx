...
const StaffManagement = () => {
    ...
    const fetchAllStaffs = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/staffsmanagement?page=${page}&limit=${limit}&staffSearchQuery=${searchQuery}`);
            const responseBody = await response.json();
            return responseBody;
        } catch (error) {
    ...
    const handleSubmitStaff = async (data) => {
        ...
        try {
            const url = currentStaffId
                ? `https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/staffsmanagement/changedetails/${currentStaffId}`
                : 'https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/staffsmanagement/create';
    ...
    const deleteStaff = async (id) => {
        setDeleting(true);
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/staffsmanagement/remove/${id}`, {
                method: "DELETE",
                headers: {
                    'Content-Type': 'application/json'
                }
    ...
    const editStaffDetails = async (id) => {
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/staffsmanagement/${id}`);
            const responseBody = await response.json();
            if (response.ok) {
                setEditStaff(true);
                                                            ...
                                                            <TableRow key={staff._id}>
                                                                <TableCell className='font-semibold'>
                                                                    <img
                                                                        ...
                                                                        src={`http://https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net:5000${staff.imageUrl}`}
                            ...
                            <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-70 flex justify-center items-center z-50">
                                <div className="relative bg-transparent p-4">
                                    ...
                                    <div className="flex justify-center">
                                        <img src={`http://https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net:5000${dbImage}`} alt="Preview" className="max-w-full max-h-[80vh] rounded-xl" />
                                    </div>
                                </div>
                            </div>
                        )}
