  ...
  const handleUpload = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3000/api/staffsmanagement/upload-image",
        {
          method: "POST",
          body: formData,
        }
    ...
    <div className="w-full bg-gray-100 px-4 py-6">
      ...
      {deleting ? (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div
            className={`bg-white border shadow-2xl flex items-center justify-between p-4 relative`}
          >
            <Box sx={{ display: "flex" }}>
              <CircularProgress />
            </Box>
      ...
      {toast && (
        <>
          ...
          <div className="fixed top-4 right-4 z-50 animate-slide-in">
            <div
              className={`relative flex items-start gap-3 px-4 py-3 bg-white shadow-lg border-l-[5px] rounded-xl
                              ...
                              <TableRow key={staff._id}>
                                <TableCell className="font-semibold">
                                  <img
                                    ...
                                    src={`http://http://localhost:3000${staff.imageUrl}`}
                ...
                <div className="border-t border-gray-300 rounded-b-md">
                  <div className="my-2 px-4 md:flex justify-between items-center">
                    <p className="font-medium text-center text-sm font-gray-700">
                      ...
                      of <span className="font-semibold">{totalStaffs}</span>{" "}
                      entries
                    </p>
                    <Pagination
                      total={totalPages}
              ...
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-70 flex justify-center items-center z-50">
                <div className="relative bg-transparent p-4">
                  ...
                  <div className="flex justify-center">
                    <img
                      src={`http://http://localhost:3000:5000${dbImage}`}
                      alt="Preview"
                      ...
                      <div className="w-full md:flex md:justify-center md:items-center">
                        ...
                        >
                          <div>
                            ...
                            {renderAvatarAlert && (
                              <AlertDialog
                                open={renderAvatarAlert}
                                onOpenChange={setRenderAvatarAlert}
                              >
                                <AlertDialogContent className="max-w-md">
                                  <AlertDialogHeader className="flex flex-col gap-2">
                                    ...
                                    <AlertDialogDescription className="text-sm text-start mt-2">
                                      Staff avatar is not selected. If you want
                                      to use your own avatar please select from
                                      form or click continue to use default.
                                    </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
                                    <AlertDialogCancel
                                      onClick={() => setValidating(false)}
                                      className="bg-white hover:bg-gray-50 text-black hover:text-black"
                                    >
                                      Cancel
                                    </AlertDialogCancel>
                                    <AlertDialogAction
                          ...
                          <div className="flex justify-between items-center my-4">
                            ...
                            {currentStep === totalSteps && !staffImage && (
                              ...
                              >
                                {validating ? "Wait..." : "Run Validation"}
                              </button>
                            )}
