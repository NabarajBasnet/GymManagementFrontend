...
const StaffDetails = ({ staffId }) => {
    ...
    const fetchStaffDetails = async () => {
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/staffsmanagement/${staffId}`);
    ...
    const handleSubmitStaff = async (data) => {
        ...
        try {
            const url = `http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/staffsmanagement/changedetails/${staffId}`
            const method = "PATCH";
