...
const StaffDetails = ({ staffId }) => {
    ...
    const fetchStaffDetails = async () => {
        try {
            const response = await fetch(`http://88.198.112.156:8000/api/staffsmanagement/${staffId}`);
    ...
    const handleSubmitStaff = async (data) => {
        ...
        try {
            const url = `http://88.198.112.156:8000/api/staffsmanagement/changedetails/${staffId}`
            const method = "PATCH";
