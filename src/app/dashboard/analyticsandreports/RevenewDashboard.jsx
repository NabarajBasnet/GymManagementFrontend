...
const RevenewDashboard = () => {
    ...
    const { count: renewdCount, members: renewdMembers, totalRevenue: totalRenewMemberRevenue, totalMembers: renewdTotalMembers, totalPages: renewdTotalPages } = revenewDataByRenew;
