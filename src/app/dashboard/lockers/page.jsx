...
const Lockers = () => {
    ...
    const getAllLockers = async () => {
        try {
            const response = await fetch(`https://revivefitnessapi.getinshapewithshreejan.com/api/lockers`);
    ...
    const registerLocker = async (data) => {
        try {
            ...
            const response = await fetch('https://revivefitnessapi.getinshapewithshreejan.com/api/lockers/put', {
                method: 'PUT',
                headers: {
    ...
    const getSingleLockerInfo = async (id) => {
        try {
            const response = await fetch(`https://revivefitnessapi.getinshapewithshreejan.com/api/lockers/${id}`);
            const responseBody = await response.json();
    ...
    const resetLocker = async (id) => {
        try {
            const response = await fetch(`https://revivefitnessapi.getinshapewithshreejan.com/api/lockers/patch/${id}`, {
                method: "PATCH",
                body: JSON.stringify({})
            })
            if (response.ok) {
