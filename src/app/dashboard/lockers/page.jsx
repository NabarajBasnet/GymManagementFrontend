...
const Lockers = () => {
    ...
    const getAllLockers = async () => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/lockers?order=${lockerOrder}&status=${lockerStatus}`);
    ...
    const registerLocker = async (data) => {
        try {
            ...
            const response = await fetch('https://gymmanagementbackend-o2l3.onrender.com/api/lockers/put', {
                method: 'PUT',
                headers: {
    ...
    const getSingleLockerInfo = async (id) => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/lockers/${id}`);
            const responseBody = await response.json();
    ...
    const resetLocker = async (id) => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/lockers/patch/${id}`, {
                method: "PATCH",
            })
            const responseBody = await response.json();
            if (response.ok) {
