...
const ScheduleManagement = () => {
    ...
    const getAllSchedules = async () => {
        try {
            const response = await fetch(`http://88.198.112.156:3000/api/staffschedules`);
            const responseBody = await response.json();
            return responseBody;
        } catch (error) {
            console.log('Error: ', error);
    ...
    const getSingleSchedule = async (id) => {
        try {
            const response = await fetch(`http://88.198.112.156:3000/api/staffschedules/${id}`);
            const responseBody = await response.json();
    ...
    const handleSave = async (data) => {
        try {
            const url = 'http://88.198.112.156:3000/api/staffschedules'
