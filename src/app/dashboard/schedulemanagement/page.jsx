...
const ScheduleManagement = () => {
    ...
    const getAllSchedules = async () => {
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/staffschedules`);
            const responseBody = await response.json();
            return responseBody;
        } catch (error) {
            console.log('Error: ', error);
    ...
    const getSingleSchedule = async (id) => {
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/staffschedules/${id}`);
            const responseBody = await response.json();
    ...
    const handleSave = async (data) => {
        try {
            const url = 'http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/staffschedules'
