  ...
  return (
    <div className="w-full bg-gray-100 dark:bg-gray-900 px-4 flex justify-center py-6">
      <div className="w-full">
        <div className="w-full p-4 mb-4 bg-white dark:bg-gray-800 border dark:border-none shadow-sm rounded-md">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
        ...
        <div className="w-full space-y-4">
          {/* Controls Section */}
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border dark:border-none border-gray-200">
