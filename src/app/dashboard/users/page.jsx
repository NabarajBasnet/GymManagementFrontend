...
const Users = () => {
    ...
    const fetchAllUsers = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/users?page=${page}&limit=${limit}&searchQuery=${searchQuery}`);
    ...
    const fetchSingleUser = async (id) => {
        reset();
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/users/${id}`);
            const responseBody = await response.json();
    ...
    const editUser = async (data) => {
        try {
            ...
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/users/update/${userId}`, {
                method: "PATCH",
                headers: {
    ...
    const deleteUser = async (id) => {
        setIsDeleting(true);
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/users/remove/${id}`, {
                method: "DELETE",
                headers: {
                    'Content-Type': 'application/json'
                },
