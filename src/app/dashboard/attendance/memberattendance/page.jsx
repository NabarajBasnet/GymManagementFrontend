...
const MemberAttendance = () => {
    ...
    const getTemporaryAttendanceHistory = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/temporary-member-attendance-history?page=${page}&limit=${limit}&searchQuery=${searchQuery}`);
    ...
    const handleValidation = async () => {
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/validate-qr/${memberId}`, {
                method: 'POST',
    ...
    const activateMembership = async () => {
        ...
        try {
            const response = await fetch(`https://38ff26b62e8fb10c5911b95dbbd1747b.serveo.net/api/members/resume-membership/${memberId}`, {
                method: "PATCH",
                headers: {
