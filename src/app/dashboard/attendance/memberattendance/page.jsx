...
const MemberAttendance = () => {
    ...
    const getTemporaryAttendanceHistory = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`http://88.198.112.156:8000/api/temporary-member-attendance-history?page=${page}&limit=${limit}&searchQuery=${searchQuery}`);
    ...
    const handleValidation = async () => {
        try {
            const response = await fetch(`http://88.198.112.156:8000/api/validate-qr/${memberId}`, {
                method: 'POST',
    ...
    const activateMembership = async () => {
        ...
        try {
            const response = await fetch(`http://88.198.112.156:8000/api/members/resume-membership/${memberId}`, {
                method: "PATCH",
                headers: {
