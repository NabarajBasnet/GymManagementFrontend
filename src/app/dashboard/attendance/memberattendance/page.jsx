...
const MemberAttendance = () => {
    ...
    const getTemporaryAttendanceHistory = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`gymmanagementbackend-o2l3.onrender.com/api/temporary-member-attendance-history?page=${page}&limit=${limit}&searchQuery=${searchQuery}`);
    ...
    const handleValidation = async () => {
        try {
            const response = await fetch(`gymmanagementbackend-o2l3.onrender.com/api/validate-qr/${memberId}`, {
                method: 'POST',
    ...
    const activateMembership = async () => {
        ...
        try {
            const response = await fetch(`gymmanagementbackend-o2l3.onrender.com/api/members/resume-membership/${memberId}`, {
                method: "PATCH",
                headers: {
