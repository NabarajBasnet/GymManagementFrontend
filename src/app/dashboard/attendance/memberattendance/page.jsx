...
const MemberAttendance = () => {
    ...
    const getTemporaryAttendanceHistory = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/temporary-member-attendance-history?page=${page}&limit=${limit}&searchQuery=${searchQuery}`);
    ...
    const handleValidation = async () => {
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/validate-qr/${memberId}`, {
                method: 'POST',
    ...
    const activateMembership = async () => {
        ...
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/members/resume-membership/${memberId}`, {
                method: "PATCH",
                headers: {
