...
const MemberAttendance = () => {
    ...
    const getTemporaryAttendanceHistory = async ({ queryKey }) => {
        const [, page] = queryKey;
        try {
            const response = await fetch(`https://revivefitnessserverapi.nabarajbasnet.com/api/temporary-member-attendance-history?page=${page}&limit=${limit}`);
    ...
    const handleValidation = async () => {
        setLoading(true);
        try {
            const response = await fetch(`https://revivefitnessserverapi.nabarajbasnet.com/api/validate-qr/${memberId}`, {
                method: 'POST',
