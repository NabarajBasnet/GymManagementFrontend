...
const AttendanceHistory = () => {
    ...
    const fetchAllMembers = async () => {
        try {
            setIsLoading(true);
            const response = await fetch(`http://88.198.112.156:8000/api/members?startDate=${startDate}&endDate=${endDate}`);
    ...
    const fetchAttendanceHistory = async () => {
        ...
        try {
            setIsLoading(true);
            const staffsAttendanceURL = `http://88.198.112.156:8000/api/staff-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
            const membersAttendanceURL = `http://88.198.112.156:8000/api/member-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
