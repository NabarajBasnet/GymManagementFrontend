...
const AttendanceHistory = () => {
    ...
    const fetchAllMembers = async () => {
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/members?startDate=${startDate}&endDate=${endDate}`);
    ...
    const fetchAttendanceHistory = async () => {
        try {
            const staffsAttendanceURL = `http://88.198.115.156:3000/api/staff-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
            const membersAttendanceURL = `http://88.198.115.156:3000/api/member-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
