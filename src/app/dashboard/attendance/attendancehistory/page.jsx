...
const AttendanceHistory = () => {
    ...
    const fetchAllMembers = async () => {
        try {
            const response = await fetch(`gymmanagementbackend-o2l3.onrender.com/api/members?startDate=${startDate}&endDate=${endDate}`);
    ...
    const fetchAttendanceHistory = async () => {
        try {
            const staffsAttendanceURL = `gymmanagementbackend-o2l3.onrender.com/api/staff-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
            const membersAttendanceURL = `gymmanagementbackend-o2l3.onrender.com/api/member-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
