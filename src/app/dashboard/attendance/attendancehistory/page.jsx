...
const AttendanceHistory = () => {
    ...
    const fetchAllMembers = async () => {
        try {
            const response = await fetch(`http://gymmanagementbackend-o2l3.onrender.com:3000/api/members?startDate=${startDate}&endDate=${endDate}`);
    ...
    const fetchAttendanceHistory = async () => {
        try {
            const staffsAttendanceURL = `http://gymmanagementbackend-o2l3.onrender.com:3000/api/staff-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
            const membersAttendanceURL = `http://gymmanagementbackend-o2l3.onrender.com:3000/api/member-attendance-history/${id}?page=${currentPage}&limit=${limit}&startDate=${startDate}&endDate=${endDate}`;
