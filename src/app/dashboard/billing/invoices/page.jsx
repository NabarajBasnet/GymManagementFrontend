...
`;
    ...
    const postInvoice = async (data) => {
        ...
        try {
            ...
            const response = await fetch(`http://88.198.115.156:3000/api/accounting/invoicemanagement/`, {
                method: "POST",
                headers: {
    ...
    const getAllInvoices = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/accounting/invoicemanagement?page=${page}&limit=${limit}&searchQuery=${searchQuery}&sortBy=${sortBy}&sortOrderDesc=${sortOrderDesc}`);
            const responseBody = await response.json();
            return responseBody;
        } catch (error) {
            console.log("Error: ", error);
    ...
    const getSingleSalesInvoice = async (id) => {
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/accounting/invoicemanagement/${id}`);
            const responseBody = await response.json();
