...
const PaymentInvoice = () => {
    ...
    const getAllInvoices = async ({ queryKey }) => {
        ...
        try {
            const response = await fetch(`http://88.198.112.156:3100/api/invoice/v2?page=${page}&limit=${limit}&invoiceSearchQuery=${searchQuery}&sortBy=${sortBy}&sortOrderDesc=${sortOrderDesc}`);
    ...
    const resendInvoiceToMember = async (memberId, invoiceId) => {
        ...
        try {
            const response = await fetch(`http://88.198.112.156:3100/api/invoice/v2/resend-invoice?memberId=${memberId}&invoiceId=${invoiceId}`)
    ...
    const deleteSalesInvoice = async (id) => {
        try {
            const response = await fetch(`http://88.198.112.156:3100/api/invoice/V2/${id}`, {
                method: "DELETE",
            });
            const responseBody = await response.json();
            if (response.ok) {
    ...
    const handleBulkDelete = async () => {
        ...
        try {
            const response = await fetch('http://88.198.112.156:3100/api/invoice/v2/bulk-delete', {
                method: 'DELETE',
                headers: {
