...
const MemberDetails = ({ memberId }) => {
    ...
    const uploadMemberImage = async () => {
        ...
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/members/${memberId}`, {
                method: "PATCH",
                headers: {
    ...
    const holdMembership = async () => {
        ...
        try {
            const response = await fetch(`http://88.198.115.156:3000/api/members/hold-membership/${memberId}`, {
                method: "PATCH",
                headers: {
                    'Content-Type': 'application/json'
                },
