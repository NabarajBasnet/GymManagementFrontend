  ...
  return (
    <div className="w-full bg-gray-100 px-4 py-8">
      ...
      <div className="w-full mt-4 flex justify-center">
        <div
          className="flex justify-between items-center bg-blue-50 border rounded-md py-2 w-full cursor-pointer"
          onClick={() => setRenderProfileDetails(!renderProfileDetails)}
        >
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <FaChevronUp
                  className={`mx-4 text-blue-600 cursor-pointer h-4 w-4 transition-transform duration-300 ${
                    renderProfileDetails ? "rotate-180" : "rotate-0"
                  }`}
                />
              </TooltipTrigger>
              <TooltipContent>
                ...
                {data ? (
                  ...
                  >
                    <div
                      ...
                      onClick={() =>
                        setRenderPersonalInformationForm(
                          !renderPersonalInformationForm
                        )
                      }
                    >
                      <h1 className="mx-4 text-blue-600 font-semibold">
                    ...
                    <div
                      className="bg-blue-50 rounded-md border py-2 my-2 w-full cursor-pointer"
                      onClick={() =>
                        setRenderMembershipInformationForm(
                    ...
                    <div
                      className="bg-blue-50 border rounded-md py-2 my-2 w-full cursor-pointer"
                      onClick={() =>
                        setRenderPaymentDetailForm(!renderPaymentDetailForm)
                      }
                    >
                      <h1 className="mx-4 text-blue-600 font-semibold">
                        Payment Details
