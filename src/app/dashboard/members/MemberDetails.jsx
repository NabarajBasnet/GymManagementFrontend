...
const MemberDetails = ({ memberId }) => {
    ...
    const uploadMemberImage = async () => {
        ...
        try {
            const response = await fetch(`https://94d6-120-89-104-124.ngrok-free.app/api/members/${memberId}`, {
                method: "PATCH",
                headers: {
    ...
    const holdMembership = async () => {
        ...
        try {
            const response = await fetch(`https://94d6-120-89-104-124.ngrok-free.app/api/members/hold-membership/${memberId}`, {
                method: "PATCH",
                headers: {
                    'Content-Type': 'application/json'
                },
