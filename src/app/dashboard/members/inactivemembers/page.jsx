            ...
            <div className='w-full p-6' onClick={() => setToast(false)}>
                ...
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Inactive Memberships</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            ...
            <div className="w-full md:flex justify-between items-center bg-gray-100 px-4">
                <div className="w-full md:w-6/12 flex items-center gap-3 px-4 rounded-lg">
                    ...
                    <select
                        ...
                        className="px-3 py-1 border border-gray-300 bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                    ...
                    <div className="w-full flex justify-start">
                        <div className="w-full overflow-x-auto">
                            <Table className='w-full overflow-x-auto'>
                                ...
                                <TableFooter>
                                    <TableRow>
                                        <TableCell colSpan={3}>Total Inactive Memberships</TableCell>
                                        <TableCell className="text-right">{totalInactiveCount}</TableCell>
                                    </TableRow>
                                </TableFooter>
                            </Table>
                        </div>
