...
const MembershipLogs = () => {
    ...
    const getMembershipLogs = async ({ queryKey }) => {
        ...
        try {
            ...
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/members/membershiplogs/${memberId}?page=${page}&limit=${limit}${dateParams}`);
            const responseBody = await response.json();
