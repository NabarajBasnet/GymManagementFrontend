...
const Users = () => {
  ...
  const fetchAllUsers = async ({ queryKey }) => {
    ...
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/systemusers?page=${page}&limit=${limit}&searchQuery=${searchQuery}`
      );
  ...
  const fetchSingleUser = async (id) => {
    ...
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/systemusers/${id}`
      );
      const responseBody = await response.json();
  ...
  const editUser = async (data) => {
    try {
      ...
      const response = await fetch(
        `http://88.198.112.156:8000/api/systemusers/update/${userId}`,
        {
          method: "PATCH",
          headers: {
  ...
  const deleteUser = async (id) => {
    ...
    try {
      const response = await fetch(
        `http://88.198.112.156:8000/api/systemusers/remove/${id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
