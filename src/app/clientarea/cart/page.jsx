...
const TenantCartManagement = () => {
  ...
  return (
    <div className="w-full p-6 min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center">
      {cart && (
      ...
      {cart?.[0]?.items?.length === 0 || !cart ? (
        <Card className="w-full max-w-xl h-80 mx-auto bg-white dark:bg-gray-800 dark:border-gray-700 shadow-lg">
