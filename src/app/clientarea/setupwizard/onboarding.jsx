        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950">
            ...
            <div className="relative container mx-auto px-4 py-8 max-w-6xl">
                    ...
                    <div className="px-8 lg:px-16 py-8 bg-gradient-to-r from-slate-50/50 to-indigo-50/50 dark:from-slate-800/50 dark:to-slate-900/50 border-t border-slate-200/50 dark:border-slate-700/50">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="w-full lg:w-auto px-8 py-5 font-semibold border-2 border-slate-300 dark:border-slate-600 hover:border-indigo-400 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-950/30 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300 rounded-md"
                            >
                            ...
                            <div className="flex flex-col lg:flex-row items-center gap-4">
                                ...
                                <Button
                                    ...
                                    className="px-6 py-5 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 font-medium hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-all duration-300"
                                >
                                    Skip setup for now
                                </Button>
                                ...
                                <Button
                                    onClick={goNext}
                                    className="w-full lg:w-auto px-8 py-5 bg-gray-700 hover:bg-gray-800 text-white font-bold shadow-md hover:shadow-lg transition-all duration-300 rounded-md transform hover:scale-105"
                                >
                ...
                <div className="mt-12 text-center">
                    <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/60 dark:bg-slate-900/60 backdrop-blur-sm rounded-full border border-white/20 dark:border-slate-700/50 shadow-lg">
                        <span className="text-lg">🤝</span>
                        <span className="text-slate-600 text-sm dark:text-slate-300 font-medium">
                            Need help?
                        </span>
                        <a
                            href="#"
                            className="text-sm font-medium text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-bold hover:underline transition-colors duration-300"
                        >
                            Contact Support →
                        </a>
                    </div>
