...
const TenantDashboard = () => {
  ...
  const logOutTenant = async () => {
    try {
      const response = await fetch(`http://88.198.112.156:8000/api/tenant/auth/logout`, {
        method: "POST",
        headers: {
  ...
  const getStaffsByTenant = async () => {
    try {
      const request = await fetch(`http://88.198.112.156:8000/api/staffsmanagement/by-tenant`);
  ...
  const getSystemUsersByTenant = async () => {
    try {
      const request = await fetch(`http://88.198.112.156:8000/api/systemusers/system-users-by-tenant`);
      const responseBody = await request.json();
      return responseBody;
    } catch (error) {
      console.log("Error: ", error);
  ...
  const getMembersByTenant = async () => {
    try {
      const request = await fetch(`http://88.198.112.156:8000/api/members/members-by-tenant`);
      const responseBody = await request.json();
      return responseBody;
    } catch (error) {
      soonerToast.error(error.message);
