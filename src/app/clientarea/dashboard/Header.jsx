...
const RootUserHeader = ({ activeTab }) => {
    ...
    const tenantName = tenant?.organizationName || '';
    const tenantStatus = tenant?.tenantStatus || '';
                ...
                <div className="flex justify-between items-center h-16">
                            ...
                            <SheetContent side="left" className="w-[280px] sm:w-[300px] p-0">
                                <div className="h-full flex flex-col">
                                    ...
                                    {loggedInTenant && (
                                        <div className="px-4 py-6 border-b border-gray-200">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-3">
                                                    <p className="font-medium text-gray-900">{loggedInTenant?.organizationName}</p>
                                    ...
                                    <div className="px-4 py-4 border-t border-gray-200">
                                        <p className="text-sm my-3 text-gray-500 flex items-center">
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-56">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem className='cursor-pointer text-red-600' onClick={logOutTenant}>
                                <LogOut />
                                Log out
                            </DropdownMenuItem>
                        </DropdownMenuContent>
