...
const StaffHeader = ({ activeTab }) => {
    ...
    const navItems = [
        { id: '/MyProfile', icon: <CgProfile size={20} />, label: "Qr Code", color: "from-blue-500 to-cyan-500" },
        // { id: '/MyProfile/chats', icon: <MessageSquare size={20} />, label: "Chat", color: "from-green-500 to-emerald-500" },
        { id: '/MyProfile/socketcheckin', icon: <FaUserCheck size={20} />, label: "Socket Check In", color: "from-blue-500 to-sky-500" },
        ...
        // { id: '/MyProfile/feedbacksandratings', icon: <VscFeedback size={20} />, label: "Feedbacks & Ratings", color: "from-pink-500 to-rose-500" },
