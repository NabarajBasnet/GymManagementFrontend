...
const MyProfile = () => {
    ...
    const fetchStaffDetails = async () => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/loggedin-staff`);
    ...
    const fetchStaffQr = async () => {
        try {
            ...
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/staffqr/${staffId}`);
            const responseBody = await response.json();
            if (!response.ok) {
