...
const TaskManagement = () => {
    ...
    const fetchTasks = async () => {
        try {
            ...
            const url = new URL(`https://gymmanagementbackend-o2l3.onrender.com/api/tasks/get-my-tasks/${staffId}`);
    ...
    const startTask = async (id) => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/tasks/changestatus/${id}?status=${'In Progress'}`, {
                method: "PATCH",
                headers: {
    ...
    const completeTask = async (id) => {
        try {
            const response = await fetch(`https://gymmanagementbackend-o2l3.onrender.com/api/tasks/changestatus/${id}?status=${'Completed'}`, {
                method: "PATCH",
                headers: {
                    'Content-Type': 'application/json',
                },
