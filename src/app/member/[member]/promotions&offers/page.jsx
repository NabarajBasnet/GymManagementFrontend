...
const OfferShowcase = () => {
    ...
    const baseURL = `http://88.198.112.156:3100/api/promotionsandoffers/`;
    ...
    const getPopularityScore = (offer) => {
        // Calculate a popularity score based on usage
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6">
                    <div className="flex flex-col md:flex-row gap-4 items-center">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <select
                                className="border border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                {offers && offers.length > 0 ? (
                                            ...
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        ...
                                                        <span className="text-sm text-gray-600">{popularityScore}</span>
                                                    </div>
                                                </div>
                                                <div className="flex items-center space-x-2">
                                                    {offer.isActive === 'on' && (
                                        ...
                                        <div className="px-6 pb-6">
                                            ...
                                            <div className="space-y-3 mb-6">
                                                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        <code className="bg-white px-3 py-1 rounded-lg font-mono text-sm border">
                                                            {offer.promoCode}
                                                        </code>
                                                        <button
                                                ...
                                                <div className="flex items-center justify-between text-sm">
                                                    ...
                                                    <span className="font-medium text-gray-900">${offer.minimumPurchase || 0}</span>
                                                </div>
                                            ...
                                            <div className="flex space-x-3">
                                                ...
                                                <button className="p-3 border border-gray-300 hover:border-gray-400 rounded-xl transition-colors group">
                                                    <Share2 className="h-5 w-5 text-gray-600 group-hover:text-gray-800" />
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div className="text-center py-20">
                        ...
                        <h3 className="text-2xl font-semibold text-gray-800 mb-3">No Active Offers</h3>
