...
export function NewRadialChart() {
    ...
    const getTotalMembers = async () => {
        try {
            const response = await fetch(`http://https://gymmanagementbackend-o2l3.onrender.com:3000/api/members?startDate=${startDate}&endDate=${endDate}&limit=${limit}&page=${currentPage}`);
                ...
                <Table className='min-w-full'>
                    ...
                    <TableBody>
                        {newAdmissions && newAdmissions.length > 0 ? (
                            ...
                            <TableRow className='bg-white hover:bg-pink-100 text-gray-800 hover:text-gray-900'>
                    ...
                    <TableFooter>
                        <TableRow className='bg-white hover:bg-pink-100 text-gray-800 hover:text-gray-900'>
                            <TableCell className="text-left">Total New Members</TableCell>
                            <TableCell className="text-left">{newAdmissionsLength}</TableCell>
                        </TableRow>
                    </TableFooter>
                </Table>
